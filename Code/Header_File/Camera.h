...
namespace BeastEngine
{
	...
	{
	public:
		[[nodiscard]] Vector2 World_To_Screen_Point(Vector3 pos) const; //ワールド座標を画面上のピクセル座標に変換する
		[[nodiscard]] Vector2 World_To_Viewport_Point(Vector3 pos) const; //ワールド座標を画面上のビューポート座標に変換する
